# C# Phoenixframework Client Library

Supports any platform that can run .NET Standard 2 SDK. API is built to look close to official phoenix.js API. Check example below to see usage.
